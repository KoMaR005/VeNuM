...
° ඬ⃟💎 _${usedPrefix}удалить *<@поль>*_
° ඬ⃟💎 _${usedPrefix}группа *<открыть / закрыть>*_
° ඬ⃟💎 _${usedPrefix}датьадмина *<@поль>*_
° ඬ⃟💎 _${usedPrefix}demote *<@поль>*_
° ඬ⃟💎 _админы *<текст>*_ (использовать без префикса)
° ඬ⃟💎 _${usedPrefix}снятьадмина *<@поль>*_
° ඬ⃟💎 _${usedPrefix}инфогруппы_
° ඬ⃟💎 _${usedPrefix}ссылка_
° ඬ⃟💎 _${usedPrefix}сменитьимя *<текст>*_
° ඬ⃟💎 _${usedPrefix}setdesc *<текст>*_
° ඬ⃟💎 _${usedPrefix}invocar *<текст>*_
° ඬ⃟💎 _${usedPrefix}setwelcome *<текст>*_
° ඬ⃟💎 _${usedPrefix}setbye *<текст>*_
